...
def _gradcam_occlusion_trajwise(dataset, gradcam, 
                                        model, tag="", 
    ...
    if os.path.exists(erased_total_path) and os.path.exists(random_total_path):
        print(f"Loading existing results for p1={p1}, p2={p2}...")
        print(erased_total_path, random_total_path)
